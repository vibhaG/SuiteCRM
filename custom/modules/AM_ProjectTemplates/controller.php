...
class AM_ProjectTemplatesController extends SugarController
{
    ...
    public function action_generate_chart()
    {
        ...
        include_once('custom/modules/AM_ProjectTemplates/project_table.php');
        ...
        <div id="project">
            <div id="left_pane">
                <?php new AM_ProjectTemplatesTablecstm($project_template->id, $tasks); ?>
            </div>
            <div id="right_pane">
                <div id="gantt">
...
<?php
    ...
    public function action_update_GanttChart()
    {
        ...
        $visit_type = $_POST['visit_type'];     //Urdhvatech
    ...
    public function create_task($name, $start, $end, $project_id, $milestone_flag, $status, $project_task_id, $predecessors, $rel_type, $duration, $duration_unit, $resource, $percent_complete, $description, $actual_duration, $order_number,$visit_type)
    {
        ...
        $task->order_number = $order_number;
        $task->visit_type_c = $visit_type;  //Urdhvatech
    ...
    public function update_task($id, $name, $start, $end, $project_id, $milestone_flag, $status, $predecessors, $rel_type, $duration, $duration_unit, $resource, $percent_complete, $description, $actual_duration,$visit_type)
    {
        $task = BeanFactory::newBean('AM_TaskTemplates');
