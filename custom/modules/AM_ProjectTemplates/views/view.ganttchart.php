...
class AM_ProjectTemplatesViewGanttChart extends ViewDetail
{
    public function display()
    {
        ...
        echo '<script type="text/javascript" src="custom/modules/AM_ProjectTemplates/js/main_lib.js"></script>';
                ...
                <form id="popup_form">
                    <fieldset>
						<table width="100%">
                            ...
                            <label for="visit_type_c"><?php echo $mod_strings['LBL_VISIT_TYPE']; ?></label>
                            <?php
                            //Urdhvatech
                            echo '<select id="visit_type_c" name="visit_type_c" class="text ui-widget-content ui-corner-all">
                                    '.get_select_options_with_id($app_list_strings['visit_type_list'], '').'
                            </select>'; ?>
