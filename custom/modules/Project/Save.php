...
//Update account based on the installation account urdhvatech
if(!empty($sugarbean->ut_installation_project_1ut_installation_ida)) {
    $oInstallation = BeanFactory::getBean("UT_Installation",$sugarbean->ut_installation_project_1ut_installation_ida);
    if(!empty($oInstallation->account_id_c)){
        $sugarbean->account_id = $oInstallation->account_id_c;    
    }
}
